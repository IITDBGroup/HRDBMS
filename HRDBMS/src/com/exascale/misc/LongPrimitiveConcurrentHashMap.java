 ...
 */
public final class LongPrimitiveConcurrentHashMap implements Serializable
{
	...
	static
	{
		...
		try
		{
			...
			HASHSEED_OFFSET = UNSAFE.objectFieldOffset(LongPrimitiveConcurrentHashMap.class.getDeclaredField("hashSeed"));
			SEGSHIFT_OFFSET = UNSAFE.objectFieldOffset(LongPrimitiveConcurrentHashMap.class.getDeclaredField("segmentShift"));
			SEGMASK_OFFSET = UNSAFE.objectFieldOffset(LongPrimitiveConcurrentHashMap.class.getDeclaredField("segmentMask"));
			SEGMENTS_OFFSET = UNSAFE.objectFieldOffset(LongPrimitiveConcurrentHashMap.class.getDeclaredField("segments"));
		}
