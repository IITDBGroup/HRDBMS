...
public final class CompressedBitSet extends BitSet implements Externalizable,
        Iterable<Integer>, BitmapStorage, LogicalElement<CompressedBitSet>
{
    /**
     ...
     *                   created)
     */
    public CompressedBitSet(int bufferSize) {
     ...
     */
    public CompressedBitSet(ByteBuffer buffer) {
     ...
     * @param buffer data source
     */
    public CompressedBitSet(LongBuffer buffer) {
        this(new LongBufferWrapper(buffer));
    }

    private CompressedBitSet(Buffer buffer) {
        this.buffer = buffer;
     ...
     * @since 0.4.0
     */
    public void andNotToContainer(final CompressedBitSet a,
    ...
    public CompressedBitSet clone()  {
        CompressedBitSet clone = new CompressedBitSet(this.buffer.clone());
    ...
    public boolean equals(Object o) {
        if (o instanceof CompressedBitSet) {
            try {
                this.xorToContainer((CompressedBitSet) o,
    ...
    /**
     * Return true if the two CompressedBitSet have both at least one
     ...
     * CompressedBitSet x= ((CompressedBitSet) mybitmap.clone());
     * x.not();
     * 
     ...
     * @since 0.4.0
     */
    public void orToContainer(final CompressedBitSet a,
                              final BitmapStorage container) {
        container.clear();
        final EWAHIterator i = a.getEWAHIterator();
        final EWAHIterator j = getEWAHIterator();
     ...
     * @since 0.8.1
     */
    public static CompressedBitSet threshold(final int t,
     ...
     * @since 0.4.0
     */
    public void xorToContainer(final CompressedBitSet a,
                               final BitmapStorage container) {
        container.clear();
        final EWAHIterator i = a.getEWAHIterator();
        final EWAHIterator j = getEWAHIterator();
    ...
    public CompressedBitSet compose(CompressedBitSet a) {
     ...
     * @param container where we store the result
     */
    public void composeToContainer(final CompressedBitSet a,
                                   final CompressedBitSet container) {
        container.clear();
     ...
     * @since 0.4.3
     */
    public static CompressedBitSet and(
            final CompressedBitSet... bitmaps) {
        if (bitmaps.length == 1)
            return bitmaps[0];
        if (bitmaps.length == 2)
     ...
     * @since 0.4.5
     */
    public static CompressedBitSet bitmapOf(int... setBits) {
        CompressedBitSet a = new CompressedBitSet();
        for (int k : setBits)
            a.set(k);
        return a;
    }
     ...
     * @since 0.4.0
     */
    public static CompressedBitSet or(
            final CompressedBitSet... bitmaps) {
        if (bitmaps.length == 1)
            return bitmaps[0];
     ...
     */
    public static CompressedBitSet xor(
            final CompressedBitSet... bitmaps) {
        if (bitmaps.length == 1)
            return bitmaps[0];
    ...
    public CompressedBitSet shift(final int b) {
        ...
        CompressedBitSet answer = new CompressedBitSet(newsz);
