...
public class Huffman
{
	...
	private static HuffmanNode tree;
	  ...
	  private final static byte[][] decodeExtended =
	  {{'t','h'},{'T','H'},{'t','H'
	  },{'T','h'},{'h','e'},{'H','E'},{'h','E'},{'H','e'},
	  {'T','H','E'},{'t','h'
	  ,'e'},{'T','h','e'},{'t','H','e'},{'t','h','E'},{'T'
	  ,'H','e'},{'t','H','E'},{'T','h','E'},
	  {'i','n'},{'I','N'},{'I','n'},{'i',
	  'N'},{'e','r'},{'E','R'},{'E','r'},{'e','R'},
	  {'a','n'},{'A','N'},{'A','n'
	  ...
	  {'o','n'},{'O','N'},{
	  'O','n'},{'o','N'},{'a','t'},{'A','T'},{'A','t'},{'a','T'},
	  {'e','n'},{'E'
	  ,'N'},{'E','n'},{'e','N'},{'n','d'},{'N','D'},{'N','d'},{'n','D'},
	  {'t','i'
	  },{'T','I'},{'T','i'},{'t','I'},{'e','s'},{'E','S'},{'E','s'},{'e','S'},
	  {
	  'o','r'},{'O','R'},{'O','r'},{'o','R'},{'t','e'},{'T','E'},{'T','e'},{'t'
	  ,'E'},
	  {'o','f'},{'O','F'},{'O','f'},{'o','F'},{'e','d'},{'E','D'},{'E','d'
	  },{'e','D'},
	  {'i','s'},{'I','S'},{'I','s'},{'i','S'},{'i','t'},{'I','T'},{
	  'I','t'},{'i','T'},
	  {'a','l'},{'A','L'},{'A','l'},{'a','L'},{'a','r'},{'A'
	  ,'R'},{'A','r'},{'a','R'},
	  {'s','t'},{'S','T'},{'S','t'},{'s','T'},{'t','o'
	  },{'T','O'},{'T','o'},{'t','O'},
	  {'n','t'},{'N','T'},{'N','t'},{'n','T'},{
	  ...
	  {'i','o'},{'I','O'},{
	  'I','o'},{'i','O'},{'l','e'},{'L','E'},{'L','e'},{'l','E'},
	  {'v','e'},{'V'
	  ,'E'},{'V','e'},{'v','E'},{'c','o'},{'C','O'},{'C','o'},{'c','O'},
	  {'m','e'
	  },{'M','E'},{'M','e'},{'m','E'},{'d','e'},{'D','E'},{'D','e'},{'d','E'},
	  {
	  'h','i'},{'H','I'},{'H','i'},{'h','I'},{'r','i'},{'R','I'},{'R','i'},{'r'
	  ,'I'},
	  {'r','o'},{'R','O'},{'R','o'},{'r','O'},{'i','c'},{'I','C'},{'I','c'
	  },{'i','C'},
	  {'i','n','g'},{'I','N','G'},{'I','n','g'},{'i','N','g'},{'i',
	  'n','G'},{'I','N','g'},{'i','N','G'},{'I','n','G'},
	  {'i','o','n'},{'I','O'
	  ,'N'},{'I','o','n'},{'i','O','n'},{'i','o','N'},{'I'
	  ,'O','n'},{'i','O','N'},{'I','o','N'},
	  {'n','e'},{'N','E'},{'N','e'},{'n',
	  'E'},{'e','a'},{'E','A'},{'E','a'},{'e','A'},
	  {'r','a'},{'R','A'},{'R','a'
	  ...
	  {'l','i'},{'L','I'},{
	  'L','i'},{'l','I'},{'c','h'},{'C','H'},{'C','h'},{'c','H'},
	  {'l','l'},{'L'
	  ,'L'},{'L','l'},{'l','L'},{'b','e'},{'B','E'},{'B','e'},{'b','E'},
	  {'m','a'
	  },{'M','A'},{'M','a'},{'m','A'},{'s','i'},{'S','I'},{'S','i'},{'s','I'},
	  {
	  'o','m'},{'O','M'},{'O','m'},{'o','M'},{'u','r'},{'U','R'},{'U','r'},{'u'
	  ,'R'},
	  {'c','a'},{'C','A'},{'C','a'},{'c','A'},{'e','l'},{'E','L'},{'E','l'
	  },{'e','L'},
	  {'t','a'},{'T','A'},{'T','a'},{'t','A'},{'l','a'},{'L','A'},{
	  'L','a'},{'l','A'},
	  {'n','s'},{'N','S'},{'N','s'},{'n','S'},{'d','i'},{'D'
	  ,'I'},{'D','i'},{'d','I'},
	  {'f','o'},{'F','O'},{'F','o'},{'f','O'},{'h','o'
	  },{'H','O'},{'H','o'},{'h','O'},
	  {'p','e'},{'P','E'},{'P','e'},{'p','E'},{
	  ...
	  {'a','c'},{'A','C'},{
	  'A','c'},{'a','C'},{'o','t'},{'O','T'},{'O','t'},{'o','T'},
	  {'i','l'},{'I'
	  ,'L'},{'I','l'},{'i','L'},{'t','r'},{'T','R'},{'T','r'},{'t','R'},
	  {'l','y'
	  },{'L','Y'},{'L','y'},{'l','Y'},{'n','c'},{'N','C'},{'N','c'},{'n','C'},
	  {
	  'e','t'},{'E','T'},{'E','t'},{'e','T'},{'u','t'},{'U','T'},{'U','t'},{'u'
	  ,'T'},
	  {'s','s'},{'S','S'},{'S','s'},{'s','S'},{'s','o'},{'S','O'},{'S','o'
	  },{'s','O'},
	  {'r','s'},{'R','S'},{'R','s'},{'r','S'},{'u','n'},{'U','N'},{
	  'U','n'},{'u','N'},
	  {'l','o'},{'L','O'},{'L','o'},{'l','O'},{'w','a'},{'W'
	  ,'A'},{'W','a'},{'w','A'},
	  {'g','e'},{'G','E'},{'G','e'},{'g','E'},{'i','e'
	  },{'I','E'},{'I','e'},{'i','E'},
	  {'w','h'},{'W','H'},{'W','h'},{'w','H'},{
	  't','i','o'},{'T','I','O'},{'T','i','o'},{'t','I','o'},
	  {'t','i','O'},{'T'
	  ,'I','o'},{'T','i','O'},{'t','I','O'},{'e','n','t'},{'E'
	  ,'N','T'},{'E','n','t'},{'e','N','t'},
	  {'e','n','T'},{'E','N','t'},{'E','n'
	  ,'T'},{'e','N','T'},{'a','t','i'},{'A'
	  ,'T','I'},{'A','t','i'},{'a','T','i'},
	  ...
	  {'h','e','R'},{'H','E','r'},{'H','e'
	  ,'R'},{'h','E','R'},{'t','i','o','n'},
	  {'T','I','O','N'},{'T','i','o','n'},{'t','I','o','n'},
	  {'t','i','O','n'},{
	  't','i','o','N'},{'T','I','o','n'},{'T','i','O','n'},{'T'
	  ,'i','o','N'},{'t','I','O','n'},{'t','I','o','N'},{'t','i','O','N'},
	  {'T','I','O','n'},{'T','I','o','N'},{'T','i','O','N'},{'t','I','O','N'}
	  };
	...
	private static class Prob
	{
		...
		public Prob(int low, int high, int count)
		{
			this.low = low;
			this.high = high;
			this.count = count;
	...
	private static void buildDecode3() { int i = 0; while (i < 16777216) {
		  ...
		  byte[] array = new byte[bytes.size()]; int j = 0; for (byte b : bytes) {
		  array[j++] = b; } code.bytes = array; code.used = (short)length; decode3[i] =
		  code;
