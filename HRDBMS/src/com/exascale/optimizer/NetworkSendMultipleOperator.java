...
public final class NetworkSendMultipleOperator extends NetworkSendOperator
{
	...
	public static NetworkSendMultipleOperator deserialize(final InputStream in, final Map<Long, Object> prev) throws Exception
	{
	...
	{
		final List<CompressedOutputStream> compOuts = new ArrayList<CompressedOutputStream>(outs.size());
		for (final OutputStream out : outs.values())
		{
