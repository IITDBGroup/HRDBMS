...
public final class AntiJoinOperator implements Operator, Serializable
{
	...
	public AntiJoinOperator(final List<String> cols, final MetaData meta)
	{
		this.cols = cols;
		this.meta = meta;
	}

	public AntiJoinOperator(final Set<Map<Filter, Filter>> f, final MetaData meta)
	{
		this.f = f;
		this.meta = meta;
	...
	private AntiJoinOperator(final List<String> cols, final Set<Map<Filter, Filter>> f, final MetaData meta)
	{
		this.cols = cols;
		this.f = f;
		this.meta = meta;
	...
	public static AntiJoinOperator deserialize(final InputStream in, final Map<Long, Object> prev) throws Exception
	{
	...
	public List<String> getRights()
	{
		if (cols.size() > 0)
		{
			final List<String> retval = new ArrayList<String>(children.get(1).getCols2Pos().keySet().size());
