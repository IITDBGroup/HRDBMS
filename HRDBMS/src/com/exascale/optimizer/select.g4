...
select : insert | update | delete | createTable | createIndex | createView | dropTable | dropIndex | dropView | (('WITH' commonTableExpression (',' commonTableExpression)*)? fullSelect) ;
...
createTable : 'CREATE TABLE' tableName '(' colDef (',' colDef)* (',' primaryKey)? ')' ;
