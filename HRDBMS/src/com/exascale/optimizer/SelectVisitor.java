...
public interface SelectVisitor<T> extends ParseTreeVisitor<T> {
	 ...
	 * @return the visitor result
	 */
	T visitCreateExternalTable(SelectParser.CreateExternalTableContext ctx);
	/**
	 * Visit a parse tree produced by {@link SelectParser#generalExtTableSpec}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitGeneralExtTableSpec(SelectParser.GeneralExtTableSpecContext ctx);
	/**
	 * Visit a parse tree produced by {@link SelectParser#javaClassExtTableSpec}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitJavaClassExtTableSpec(SelectParser.JavaClassExtTableSpecContext ctx);
	/**
	 * Visit a parse tree produced by {@link SelectParser#javaClassName}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitJavaClassName(SelectParser.JavaClassNameContext ctx);
	/**
	 * Visit a parse tree produced by {@link SelectParser#keyValueList}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitKeyValueList(SelectParser.KeyValueListContext ctx);
	/**
	 * Visit a parse tree produced by {@link SelectParser#anything}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitAnything(SelectParser.AnythingContext ctx);
	/**
	 * Visit a parse tree produced by {@link SelectParser#sourceList}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitSourceList(SelectParser.SourceListContext ctx);
	/**
