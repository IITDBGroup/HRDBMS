 ...
 *
 * <p>Each <tt>ArrayListLong</tt> instance has a <i>capacity</i>.  The capacity is
 * the size of the array used to store the elements in the list.  It is always
 * at least as large as the list size.  As elements are added to an ArrayListLong,
 * its capacity grows automatically.  The details of the growth policy are not
 * specified beyond the fact that adding an element has constant amortized
 * time cost.
 *
 * <p>An application can increase the capacity of an <tt>ArrayListLong</tt> instance
 * before adding a large number of elements using the <tt>ensureCapacity</tt>
 * operation.  This may reduce the amount of incremental reallocation.
 *
 * <p><strong>Note that this implementation is not synchronized.</strong>
 * If multiple threads access an <tt>ArrayListLong</tt> instance concurrently,
 ...
 *   List list = Collections.synchronizedList(new ArrayListLong(...));</pre>
 *
 * <p><a name="fail-fast"/>
        ...
        implements RandomAccess, Cloneable, java.io.Serializable, Iterable
{
     ...
     * empty ArrayListLong with elementData == EMPTY_ELEMENTDATA will be expanded to
    ...
    public Object clone() {
        try {
            @SuppressWarnings("unchecked")
                ArrayListLong v = (ArrayListLong) super.clone();
    ...
    private final class Itr implements Iterator {
        ...
        public Long next() {
            ...
            long[] elementData = ArrayListLong.this.elementData;
