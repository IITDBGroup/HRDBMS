...
import com.exascale.optimizer.testing.LongPrimitiveConcurrentHashMap.HashEntry;
...
public class InternalConcurrentHashMap implements Serializable {
    ...
    final class ValueIterator
        extends HashIterator
    {
        public final ArrayList<Object> next()        { return super.nextEntry().value; }
        public final ArrayList<Object> nextElement() { return super.nextEntry().value; }
    }
    ...
    public final class WriteThroughEntry
    {
        ...
        public ArrayList<Object> setValue(ArrayList<Object> value) {
            ...
            ArrayList<Object> v = this.v = value;
    ...
    private void readObject(java.io.ObjectInputStream s)
        ...
        for (;;) {
            long key = s.readLong();
            ArrayList<Object> value = (ArrayList<Object>)s.readObject();
            if (key == -1)
                break;
            put(key, value);
        }
    ...
    static {
        ...
        try {
            ...
            HASHSEED_OFFSET = UNSAFE.objectFieldOffset(
                InternalConcurrentHashMap.class.getDeclaredField("hashSeed"));
            SEGSHIFT_OFFSET = UNSAFE.objectFieldOffset(
                InternalConcurrentHashMap.class.getDeclaredField("segmentShift"));
            SEGMASK_OFFSET = UNSAFE.objectFieldOffset(
                InternalConcurrentHashMap.class.getDeclaredField("segmentMask"));
            SEGMENTS_OFFSET = UNSAFE.objectFieldOffset(
                InternalConcurrentHashMap.class.getDeclaredField("segments"));
        } catch (Exception e) {
            throw new Error(e);
        }
