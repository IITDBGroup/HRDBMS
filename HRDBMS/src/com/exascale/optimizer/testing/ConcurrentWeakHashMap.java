...
public final class ConcurrentWeakHashMap<K, V> extends AbstractMap<K, V>
    ...
    static final class HashEntry<K,V> {
        ...
        HashEntry(WeakReference<K> key, int hash, HashEntry<K,V> next, V value) 
        {
            this.key = key;
            this.hash = hash;
            this.next = next;
    ...
    static final class Segment<K,V> extends ReentrantLock implements Serializable {
        ...
        boolean replace(K key, int hash, V oldValue, V newValue) {
            ...
            try {
                HashEntry<K,V> e = getFirst(hash);
                while (e != null && (e.hash != hash || !key.equals(e.getKey())))
                    e = e.next;
    ...
    abstract class HashIterator {
        ...
        public void remove() {
            ...
            ConcurrentWeakHashMap.this.removeHashEntry(lastReturned);
            lastReturned = null;
        }
    }
        ...
        implements Iterator<K>, Enumeration<K>
    {
        ...
        public K nextElement() { return super.nextEntry().getKey(); }
    }
        ...
        implements Iterator<Entry<K,V>>
    {
        public Map.Entry<K,V> next() {
            ...
            return new WriteThroughEntry(e.getKey(), e.value);
        }
    }
    ...
    private void removeHashEntry(HashEntry e)
    {
    	int i = 0;
