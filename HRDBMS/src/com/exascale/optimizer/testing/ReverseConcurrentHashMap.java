...
public final class ReverseConcurrentHashMap implements Serializable {
    ...
    {
        public final ArrayList<Object> next()        { return super.nextEntry().key; }
        public final ArrayList<Object> nextElement() { return super.nextEntry().key; }
    }
    ...
    static {
        ...
        try {
            ...
            HASHSEED_OFFSET = UNSAFE.objectFieldOffset(
                ReverseConcurrentHashMap.class.getDeclaredField("hashSeed"));
            SEGSHIFT_OFFSET = UNSAFE.objectFieldOffset(
                ReverseConcurrentHashMap.class.getDeclaredField("segmentShift"));
            SEGMASK_OFFSET = UNSAFE.objectFieldOffset(
                ReverseConcurrentHashMap.class.getDeclaredField("segmentMask"));
            SEGMENTS_OFFSET = UNSAFE.objectFieldOffset(
                ReverseConcurrentHashMap.class.getDeclaredField("segments"));
        } catch (Exception e) {
            throw new Error(e);
        }
