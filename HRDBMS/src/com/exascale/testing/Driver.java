...
import com.exascale.optimizer.AvgOperator;
import com.exascale.optimizer.CaseOperator;
import com.exascale.optimizer.CountDistinctOperator;
...
import com.exascale.optimizer.MinOperator;
...
import com.exascale.optimizer.ProjectOperator;
import com.exascale.optimizer.RenameOperator;
...
import com.exascale.optimizer.SubstringOperator;
import com.exascale.optimizer.SumOperator;
import com.exascale.optimizer.TableScanOperator;
import com.exascale.optimizer.TopOperator;
import com.exascale.optimizer.YearOperator;
import com.exascale.threads.ThreadPoolThread;

public class Driver
{
	private static Operator temp;

	private static Operator temp2;
	private static Operator temp3;
	private static Operator temp4;
	private static RootOperator parseOutput;
	private static ArrayList<String> vStr = new ArrayList<String>();
	private static ArrayList<String> vStr2 = new ArrayList<String>();
	private static ArrayList<Boolean> vBool = new ArrayList<Boolean>();
	private static ArrayList<AggregateOperator> vOp = new ArrayList<AggregateOperator>();
	...
	{
		final Phase4 retval = new Phase4(root);
		retval.optimize();
		return retval;
	}
	...
	{
		final Phase5 retval = new Phase5(root);
		retval.optimize();
		return retval;
	}
	...
	private static RootOperator getTree(int i) throws Exception
	{
		vStr.clear();
		vStr2.clear();
		vBool.clear();
		...
		{
			temp = new TableScanOperator("TPCH", "LINEITEM", meta);
			final Filter hold = new Filter("L_SHIPDATE", "LE", "DATE('1998-09-02')");
		...
		else if (i == 3)
		{
			...
			temp2.add(temp3);
			temp = temp2;
			final Filter hold1 = new Filter("C_MKTSEGMENT", "E", "'BUILDING'");
			temp2 = new SelectOperator(hold1, meta);
			temp2.add(temp);
			temp = temp2;
			final Filter hold2 = new Filter("C_CUSTKEY", "E", "O_CUSTKEY");
			temp2 = new SelectOperator(hold2, meta);
			temp2.add(temp);
			temp = temp2;
			final Filter hold3 = new Filter("L_ORDERKEY", "E", "O_ORDERKEY");
			temp2 = new SelectOperator(hold3, meta);
			temp2.add(temp);
			temp = temp2;
			final Filter hold4 = new Filter("O_ORDERDATE", "L", "DATE('1995-03-15')");
			temp2 = new SelectOperator(hold4, meta);
			temp2.add(temp);
			temp = temp2;
			final Filter hold5 = new Filter("L_SHIPDATE", "G", "DATE('1995-03-15')");
			...
			// temp2.add(temp);
			// temp = temp2;
			// for all aggregate operators - if no input rows, generate no
			// output rows
		...
		else if (i == 5)
		{
			...
			temp2.add(temp3);
			temp = temp2;
			final Filter hold1 = new Filter("C_CUSTKEY", "E", "O_CUSTKEY");
			temp2 = new SelectOperator(hold1, meta);
			temp2.add(temp);
			temp = temp2;
			final Filter hold2 = new Filter("L_ORDERKEY", "E", "O_ORDERKEY");
			temp2 = new SelectOperator(hold2, meta);
			temp2.add(temp);
			temp = temp2;
			final Filter hold3 = new Filter("L_SUPPKEY", "E", "S_SUPPKEY");
			temp2 = new SelectOperator(hold3, meta);
			temp2.add(temp);
			temp = temp2;
			final Filter hold4 = new Filter("C_NATIONKEY", "E", "S_NATIONKEY");
			temp2 = new SelectOperator(hold4, meta);
			temp2.add(temp);
			temp = temp2;
			final Filter hold5 = new Filter("S_NATIONKEY", "E", "N_NATIONKEY");
			temp2 = new SelectOperator(hold5, meta);
			temp2.add(temp);
			temp = temp2;
			final Filter hold6 = new Filter("N_REGIONKEY", "E", "R_REGIONKEY");
			temp2 = new SelectOperator(hold6, meta);
			temp2.add(temp);
			temp = temp2;
			final Filter hold7 = new Filter("R_NAME", "E", "'ASIA'");
			temp2 = new SelectOperator(hold7, meta);
			temp2.add(temp);
			temp = temp2;
			final Filter hold8 = new Filter("O_ORDERDATE", "GE", "DATE('1994-01-01')");
			temp2 = new SelectOperator(hold8, meta);
			temp2.add(temp);
			temp = temp2;
			final Filter hold9 = new Filter("O_ORDERDATE", "L", "DATE('1995-01-01')");
		...
		{
			temp = new TableScanOperator("TPCH", "LINEITEM", meta);
			final Filter hold1 = new Filter("L_SHIPDATE", "GE", "DATE('1994-01-01')");
			temp2 = new SelectOperator(hold1, meta);
			temp2.add(temp);
			temp = temp2;
			final Filter hold2 = new Filter("L_SHIPDATE", "L", "DATE('1995-01-01')");
			temp2 = new SelectOperator(hold2, meta);
			temp2.add(temp);
			temp = temp2;
			final Filter hold3 = new Filter("L_DISCOUNT", "GE", "0.05");
			temp2 = new SelectOperator(hold3, meta);
			temp2.add(temp);
			temp = temp2;
			final Filter hold4 = new Filter("L_DISCOUNT", "LE", "0.07");
			temp2 = new SelectOperator(hold4, meta);
			temp2.add(temp);
			temp = temp2;
			final Filter hold5 = new Filter("L_QUANTITY", "L", "24");
			temp2 = new SelectOperator(hold5, meta);
			temp2.add(temp);
			temp = temp2;
		...
		else if (i == 7)
		{
			...
			temp2.add(temp3);
			temp = temp2;
			final Filter hold1 = new Filter("S_SUPPKEY", "E", "L_SUPPKEY");
			temp2 = new SelectOperator(hold1, meta);
			temp2.add(temp);
			temp = temp2;
			final Filter hold2 = new Filter("O_ORDERKEY", "E", "L_ORDERKEY");
			temp2 = new SelectOperator(hold2, meta);
			temp2.add(temp);
			temp = temp2;
			final Filter hold3 = new Filter("C_CUSTKEY", "E", "O_CUSTKEY");
			temp2 = new SelectOperator(hold3, meta);
			temp2.add(temp);
			temp = temp2;
			final Filter hold4 = new Filter("S_NATIONKEY", "E", "N_NATIONKEY");
			temp2 = new SelectOperator(hold4, meta);
			temp2.add(temp);
			temp = temp2;
			final Filter hold5 = new Filter("C_NATIONKEY", "E", "N_NATIONKEY2");
			temp2 = new SelectOperator(hold5, meta);
			temp2.add(temp);
			temp = temp2;
			final Filter hold6 = new Filter("L_SHIPDATE", "GE", "DATE('1995-01-01')");
			temp2 = new SelectOperator(hold6, meta);
			temp2.add(temp);
			temp = temp2;
			final Filter hold7 = new Filter("L_SHIPDATE", "LE", "DATE('1996-12-31')");
			temp2 = new SelectOperator(hold7, meta);
			temp2.add(temp);
			temp = temp2;
			final ArrayList<Filter> hold8 = new ArrayList<Filter>();
			hold8.add(new Filter("N_NAME", "E", "'FRANCE'"));
			hold8.add(new Filter("N_NAME", "E", "'GERMANY'"));
			temp2 = new SelectOperator(hold8, meta);
			temp2.add(temp);
			temp = temp2;
			final ArrayList<Filter> hold9 = new ArrayList<Filter>();
			hold9.add(new Filter("N_NAME", "E", "'FRANCE'"));
			hold9.add(new Filter("N_NAME2", "E", "'FRANCE'"));
			temp2 = new SelectOperator(hold9, meta);
			temp2.add(temp);
			temp = temp2;
			final ArrayList<Filter> hold10 = new ArrayList<Filter>();
			hold10.add(new Filter("N_NAME2", "E", "'GERMANY'"));
			hold10.add(new Filter("N_NAME", "E", "'GERMANY'"));
			temp2 = new SelectOperator(hold10, meta);
			temp2.add(temp);
			temp = temp2;
			final ArrayList<Filter> hold11 = new ArrayList<Filter>();
		...
		else if (i == 8)
		{
			...
			temp2.add(temp);
			temp = temp2;
			final HashMap<Filter, Filter> vFilter = new HashMap<Filter, Filter>();
			final Filter filter = new Filter("NATION", "E", "'BRAZIL'");
			vFilter.put(filter, filter);
			final HashSet<HashMap<Filter, Filter>> set = new HashSet<HashMap<Filter, Filter>>();
			set.add(vFilter);
			final ArrayList<HashSet<HashMap<Filter, Filter>>> filters = new ArrayList<HashSet<HashMap<Filter, Filter>>>();
			filters.add(set);
			final ArrayList<String> vObj = new ArrayList<String>();
			vObj.add("VOLUME");
			vObj.add("0");
		...
		else if (i == 11)
		{
			...
			temp2.add(temp);
			final Operator subselect = temp2;
			temp = new TableScanOperator("TPCH", "NATION", meta);
			temp2 = new TableScanOperator("TPCH", "SUPPLIER", meta);
			temp3 = new ProductOperator(meta);
			temp3.add(temp);
		...
		else if (i == 14)
		{
			...
			temp = temp2;
			final HashMap<Filter, Filter> vFilter = new HashMap<Filter, Filter>();
			final Filter filter = new Filter("P_TYPE", "LI", "'PROMO%'");
			vFilter.put(filter, filter);
			final HashSet<HashMap<Filter, Filter>> set = new HashSet<HashMap<Filter, Filter>>();
			set.add(vFilter);
			final ArrayList<HashSet<HashMap<Filter, Filter>>> filters2 = new ArrayList<HashSet<HashMap<Filter, Filter>>>();
			filters2.add(set);
			final ArrayList<String> vObj = new ArrayList<String>();
			vObj.add("_E1");
			vObj.add("0.0");
		...
		if (i == 16)
		{
			...
			temp2.add(temp);
			temp = temp2;
			final ArrayList<Filter> vFilter = new ArrayList<Filter>();
		...
		if (i == 20)
		{
			...
			temp2 = new ProjectOperator(vStr, meta);
			temp2.add(temp);
			final Operator subquery1 = temp2;
			temp = new TableScanOperator("TPCH", "LINEITEM", meta);
			...
			temp2.add(temp);
			temp = temp2;
			final Operator subquery2 = temp2;
			temp = new TableScanOperator("TPCH", "PARTSUPP", meta);
	...
	private static void printHeaders(RootOperator op)
	{
		String line = "";
		for (final Map.Entry entry : op.getPos2Col().entrySet())
		{
			line += (entry.getValue() + "\t");
		}
	...
	private static void runQuery(RootOperator parseOutput)
	{
		try
		{
			parseOutput.start();
