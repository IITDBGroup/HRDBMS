...
public class PreLoadSupplierMap extends Mapper<Object, Text, Text, Text>
{
	private Text outKey;
	...
	protected void map(Object key, Text row, Context context) throws IOException, InterruptedException
	{
		...
		outKey = new Text("S" + (Math.abs(partKey.hashCode()) % Integer.parseInt(context.getConfiguration().get("HRDBMS.nodes"))));
